...
> Clean load .env files into os.environ

[![PyPI version](https://badge.fury.io/py/clean-env-loader.svg)](https://pypi.org/project/clean-env-loader/)
...
```bash
pip install clean-env-loader
```

## Quick Start

```python
from clean_env_loader import loader
...
from clean_env_loader import batch
